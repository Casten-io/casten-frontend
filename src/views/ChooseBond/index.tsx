...
import BondTitleIcon from "../../assets/icons/bond-title.png";
            ...
            <Zoom in={true}>
                <div className="choose-bond-view-card">
                    <div className="choose-bond-view-card-header">
                        <p className="choose-bond-view-card-title">
                            <span>Bond (</span>
                            <img src={BondTitleIcon} />
                            <span>)</span>
                        </p>
                    </div>
                    ...
                    <Grid container item xs={12} spacing={2} className="choose-bond-view-card-metrics">
                        ...
                        <Grid item xs={12} sm={6}>
                            <Box textAlign="center">
                                <p className="choose-bond-view-card-metrics-title">D33D Price</p>
