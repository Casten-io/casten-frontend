                        ...
                        {/* {bond.isLP && (
                            <div>
                                <Link href={bond.lpUrl} target="_blank">
                                    <p className="bond-name__view-contract">View Contract</p>
                                </Link>
                            </div>
                        )} */}
                    </div>
...
export function BondTableData({ bond }: IBondProps) {
    ...
    return (
        <>
            <TableRow className="bond-table-row">
                ...
                <TableCell style={{ width: "97px" }}>
                    <Link component={NavLink} to={`/bonds/${bond.name}`}>
                        <div className="bond-table-btn">Bond</div>
                    </Link>
                </TableCell>
            </TableRow>

            <TableRow className="bond-table-empty-row" />
        </>
    );
}
