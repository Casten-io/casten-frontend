                    ...
                    <div className="content-container">
                        ...
                        <div className="details-container">
                            <Grid container spacing={2} className="details">
                                ...
                                <Grid item xs={5} className="details-item">
                                    <Typography className="normie">Revenue Based/Invoice Discounting</Typography>
                                </Grid>
                                <Grid item xs={5} className="details-item">
                                ...
                                <Grid item xs={5} className="details-item">
                                    <Typography className="bold">Data Underwriting Capabilities</Typography>
                                </Grid>
                                <Grid item xs={5} className="details-item">
                                    <Typography className="normie">
                                        Revenue based/Invoice Discounting. Real time asset description. Revenue based/Invoice DiscountingReal time asset description.
                                    </Typography>
                                </Grid>
                            </Grid>
                        </div>
