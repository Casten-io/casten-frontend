...
export interface BondOpts {
    ...
    readonly reserveDecimals: number;   // decimals of reserve contract, default 18
    readonly allowedHappyHour: boolean; // Strategy allowed for happy hour
}
...
export abstract class Bond {
    ...
    public readonly allowedHappyHour?:boolean;

    // The following two fields will differ on how they are set depending on bond type
    public abstract isLP: boolean;
    public abstract isNFT: boolean;
    ...
    public abstract getD33DAmount(networkID: Networks, provider: StaticJsonRpcProvider): Promise<number>;
    ...
    constructor(type: BondType, bondOpts: BondOpts) {
        ...
        this.reserveDecimals = bondOpts.reserveDecimals;
        this.allowedHappyHour = bondOpts.allowedHappyHour;
    }
